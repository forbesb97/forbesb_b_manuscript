...
workspace<-'D:/Analyses/ladder_fuel_full_process_take5/random_forests_tls'
setwd(workspace)
# files to process

files <-
  c('ladder_fuel_metrics_rbr_tls.csv'
  )
...
predictors <-
  c('tls_ladder_fuel_1to2',
    'tls_ladder_fuel_1to3',
    'tls_ladder_fuel_2to3',
    'tls_ladder_fuel_3to4',
    'tls_ladder_fuel_2to4',
    'tls_ladder_fuel_1to4',
    'tls_ladder_fuel_1to5',
    'tls_ladder_fuel_2to5',
    'tls_ladder_fuel_3to5',
    'tls_ladder_fuel_4to5',
    'tls_ladder_fuel_1to6',
    'tls_ladder_fuel_2to6',
    'tls_ladder_fuel_3to6',
    'tls_ladder_fuel_4to6',
    'tls_ladder_fuel_5to6',
    'tls_ladder_fuel_1to7',
    'tls_ladder_fuel_2to7',
    'tls_ladder_fuel_3to7',
    'tls_ladder_fuel_4to7',
    'tls_ladder_fuel_5to7',
    'tls_ladder_fuel_6to7',
    'tls_ladder_fuel_1to8',
    'tls_ladder_fuel_2to8',
    'tls_ladder_fuel_3to8',
    'tls_ladder_fuel_4to8',
    'tls_ladder_fuel_5to8',
    'tls_ladder_fuel_6to8',
