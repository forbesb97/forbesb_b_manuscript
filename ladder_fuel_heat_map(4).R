...
data <- read_csv('D:/Analyses/ladder_fuel_full_process_take4/not_filtered/ladder-fuels_metrics_tls_zeb_als_uas_banner_210326.csv')
...
outfile <- 'D:/Analyses/ladder_fuel_full_process_take4/not_filtered/ladder-fuel_heatmap_210331.png'
