...
out_file <- 'D:/Analyses/ladder_fuel_full_process_take4/c1_tls_all_ladder_fuel_metrics.csv'
...
tls_combine <- tibble(
  ...
  tls_ladder_fuel_2to4 = numeric(),
  tls_ladder_fuel_3to4 = numeric(),
  tls_ladder_fuel_1to5 = numeric(),
  tls_ladder_fuel_2to5 = numeric(),
  tls_ladder_fuel_3to5 = numeric(),
  tls_ladder_fuel_4to5 = numeric(),
  tls_ladder_fuel_1to6 = numeric(),
  tls_ladder_fuel_2to6 = numeric(),
  tls_ladder_fuel_3to6 = numeric(),
  tls_ladder_fuel_4to6 = numeric(),
  tls_ladder_fuel_5to6 = numeric(),
  tls_ladder_fuel_1to7 = numeric(),
  tls_ladder_fuel_2to7 = numeric(),
  tls_ladder_fuel_3to7 = numeric(),
  tls_ladder_fuel_4to7 = numeric(),
  tls_ladder_fuel_5to7 = numeric(),
  tls_ladder_fuel_6to7 = numeric(),
  tls_ladder_fuel_1to8 = numeric(),
  tls_ladder_fuel_2to8 = numeric(),
  tls_ladder_fuel_3to8 = numeric(),
  tls_ladder_fuel_4to8 = numeric(),
  tls_ladder_fuel_5to8 = numeric(),
  tls_ladder_fuel_6to8 = numeric(),
...
write_csv(tls_combine,out_file)
